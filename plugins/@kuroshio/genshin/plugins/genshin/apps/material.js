...
const logger = new Logger("genshin-model-mys-mysuser")
class material extends plugin {
  constructor (ctx, session) {
    ...
    this.path =  `${common.getDataPath()}/data/material_友人A`
    this.pathOther = `${common.getDataPath()}/material_other`
  ...
  async getImg (name) {
    ...
    logger.info(`${this.e.logFnc} 下载${name}素材成功`)
